...
DISEASES = [
    ...
    },
    {
        ...
        'summary': 'Viral; firm skin nodules, fever, lagr nodes.',
    ...
    },
    {
        ...
        'criteria': [
            ...
            {'question': 'Is the sick animal an adult>?', 'options': ['Yes','No'], 'positive': ['Yes']},
    ...
    },
    {
        ...
        'criteria': [
            ...
            {'question': 'Does the animal have swollen lymph nodes?', 'options': ['Yes','No'], 'positive': ['Yes']},
            {'question': 'Is the fever very high?', 'options': ['Yes','No'], 'positive': ['Yes']},
            {'question': 'Has breathing difficulty developed?', 'options': ['Yes','No'], 'positive': ['Yes']},
            {'question': 'Is there tearing of eyes or nasal discharge?', 'options': ['Yes','No'], 'positive': ['Yes']},
            {'question': 'Are brown ear ticks visible?', 'options': ['Yes','No'], 'positive': ['Yes']},
        ]
    },
    {
        'key': 'brucellosis',
        'name': 'Brucellosis',
        'summary': 'Repro; late-term abortion, retained placenta.',
        'images': ['images/brucellosis_abortion.jpg'],
        'criteria': [
            {'question': 'Has the cow aborted in last trimester?', 'options': ['Yes','No'], 'positive': ['Yes']},
            {'question': 'Did the cow retain the placenta?', 'options': ['Yes','No'], 'positive': ['Yes']},
            {'question': 'Have multiple cows aborted or weak calves?', 'options': ['Yes','No'], 'positive': ['Yes']},
            {'question': 'Do any cattle have joint swellings (hygromas)?', 'options': ['Yes','No'], 'positive': ['Yes']},
            {'question': 'Have any bulls shown swollen testicles?', 'options': ['Yes','No','No bulls'], 'positive': ['Yes']},
            {'question': 'Any undulating fevers reported in farm workers?', 'options': ['Yes','No'], 'positive': ['Yes']},
        ]
    },
    {
        'key': 'blackleg',
        'name': 'Blackleg',
        'summary': 'Clostridial; sudden death in young cattle, muscle gas.',
        'images': ['images/blackleg_swelling.jpg'],
        'criteria': [
            {'question': 'Was a young animal found dead suddenly?', 'options': ['Yes','No'], 'positive': ['Yes']},
            {'question': 'Was there swelling in a limb/muscle before death?', 'options': ['Yes','No'], 'positive': ['Yes']},
            {'question': 'Could you feel crackling gas under the skin?', 'options': ['Yes','No','Not checked'], 'positive': ['Yes']},
            {'question': 'Did the animal have fever/depression if observed?', 'options': ['Yes','No','Not observed'], 'positive': ['Yes']},
            {'question': 'Have other young cattle died similarly?', '
